...
<body>
  <div class="container p-4 my-2">
    ...
    <div class="alert alert-success d-flex align-items-center justify-content-center fixed-top d-none" id="success"
      role="alert">
    ...
    <div class="alert alert-danger d-flex align-items-center justify-content-center fixed-top d-none" id="error"
      role="alert">
